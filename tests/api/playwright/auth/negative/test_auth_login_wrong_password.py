...
from variables import INVALID_CREDENTIALS_MESSAGE,EMILYS_WRONG_PASSWORD_CREDENTIALS


def test_auth_login_wrong_password(playwright_auth_client: PlaywrightAuthClient):
    response = playwright_auth_client.login(EMILYS_WRONG_PASSWORD_CREDENTIALS)
